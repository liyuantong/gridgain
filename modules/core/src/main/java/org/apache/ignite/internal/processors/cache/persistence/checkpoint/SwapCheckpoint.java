...
/**
 * This checkpoint ensures that all pages marked as dirty under {@link #checkpointTimeoutLock ()} will be consistently
 * saved to disk.
 */
public class SwapCheckpoint {
    /** Checkpoint worker. */
    ...
    public SwapCheckpoint(
        ...
        checkpointPageWriterFactory = new CheckpointPageWriterFactory(
            logger, snapshotMgr,
    ...
    public void threadBuf(ThreadLocal<ByteBuffer> threadBuf) {
        checkpointPageWriterFactory.threadBuf(threadBuf);
    }
    ...
    public <R> CheckpointProgress forceCheckpoint(String reason,
        ...
        return cp.wakeupForCheckpoint(0, reason, lsnr);
    }
