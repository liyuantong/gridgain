...
/**
 * Factory class for checkpoint page writer.
 */
public class CheckpointPageWriterFactory {
    /** Snapshot manager. */
    ...
    /** Interface which allows to write page to page store. */
